# Parkio social drafts — 2026-06-19
...
CAPTION: The fastest way to check Disney wait times. Free, no app needed. #DisneyWorld #DisneyParks #Disney #ParkioDaily #waittimes
```

## 2. X / Threads

```
Disney parks are running normal today — but waits still swing hour to hour.
See live wait times + what to ride right now, free: parkio.info
#DisneyWorld #DisneyParks
```
...
**Carousel slides**
```
SLIDE 1 (cover): Today at Disney — 2026-06-19
...
**Caption**
```
Calm day at the parks. Check live wait times and the best rides right now, free at parkio.info.

#DisneyWorld #DisneyParks #Disney #ParkioDaily
```
...
---
_Built by scripts/parkio-daily/social.mjs from content/guide/daily/parkio-daily-2026-06-19.json._
