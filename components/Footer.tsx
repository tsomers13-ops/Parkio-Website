...
export function Footer() {
  return (
    <footer className="border-t border-ink-100 bg-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-3 px-5 pb-4 pt-10 sm:px-8">
        <p className="text-xs text-ink-400">
          Parkio is an independent app and is not affiliated with or endorsed by
          Disney.
        </p>
      </div>
      <div className="mx-auto flex max-w-7xl flex-col gap-6 border-t border-ink-100 px-5 pb-10 pt-6 sm:flex-row sm:items-center sm:justify-between sm:px-8">
